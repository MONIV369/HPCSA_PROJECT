...
# NumPy arrays for ultra-fast sampling
fraud_indices = y_valid[y_valid == 1].index.to_numpy()
legit_indices = y_valid[y_valid == 0].index.to_numpy()
...
def predict():
    ...
    try:
        ...
        return "<h2>Invalid input amount</h2><a href='/'>Go Back</a>", 400
            ...
            with conn.cursor() as cursor:
                cursor.execute(
                    """INSERT INTO prediction_logs(
                        transaction_amount, card_type, device_type,
                        browser, prediction, fraud_probability, response_time_ms
